...
class Cypher:
    ...
    def create_neo_match(self, labels:set, key:str, value, var:str='n') -> str:
    ...
    def apoc_node_create(self, key:str='nodes', var:str='n') -> str:
    ...
    def bulk_node_exists_query(self,field:str, labels:str=None, only_field:bool=False) -> str:
    ...
    def node_match_query(self, labels:set=None, properties:dict={}, limit:int=None) -> str:
    ...
    def apoc_edge_create(self, key:str='edges') -> str:
